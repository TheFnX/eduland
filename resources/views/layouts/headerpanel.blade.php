               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item has-treeview menu-open">
                    <a href="#" class="nav-link">
                        ...
                        <p style="color: aliceblue">Escritorio</p>  
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
                        <i class="nav-icon fas fa-cube"></i>
                        <p style="color: aliceblue">Categorias
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/categoria/create" class="nav-link">
                                ...
                                <p style="color: aliceblue">Categorias</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/subcategoria" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p style="color: aliceblue">Subcategorias</p>
                            </a>
                        </li>
                ...
                {{-- <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
                        ...
                        <p style="color: aliceblue">Subcategoria
                            <i class="right fas fa-angle-left"></i>
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/cliente" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p style="color: aliceblue">Clientes</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/proveedor" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p style="color: aliceblue">Provedores</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    <a href="/evento/create" class="nav-link">
                        <i class="fa fa-th-list nav-icon" aria-hidden="true"></i>
                          <p style="color: aliceblue">Eventos</p>                
                      </a>
                  {{-- <ul class="nav nav-treeview"> --}}
                      {{-- <li class="nav-item">
                          <a href="pages/charts/chartjs.html" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p style="color: aliceblue">Ventas</p>
                          </a>
                      </li> --}}
                      {{-- <li class="nav-item">
